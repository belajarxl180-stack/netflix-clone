...
export default async function MovieDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main className="bg-black text-white min-h-screen">
      {/* Navbar */}
      <header className="flex items-center justify-between px-10 py-6 bg-black/80 backdrop-blur-sm fixed w-full z-50">
        <Link href="/">
        ...
        <nav className="flex gap-6 text-lg">
          ...
          <Link href="/watchlist" className="hover:text-red-500">My List</Link>
        </nav>
      </header>

      {/* Hero Section with Backdrop */}
      <section 
        className="relative h-[60vh] flex items-end pt-20"
        style={{
      ...
      {/* Movie Details */}
      <div className="relative -mt-32 z-10 px-10 pb-20">
