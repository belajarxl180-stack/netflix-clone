...
export const metadata: Metadata = {
  title: "Mbah Mur Trailer - Nonton Trailer Film Terbaru & Terlengkap",
  ...
  authors: [{ name: "Mbah Mur Trailer" }],
  openGraph: {
    title: "Mbah Mur Trailer - Nonton Trailer Film Terbaru",
